...
def display_ascii_art(file_path='ascii_art.txt'):
    """Display ASCII art from a specified text file."""
    try:
        # Try to read the ASCII art from the file
        with open(file_path, 'r') as file:
            ascii_art = file.read()
            console.print(ascii_art)  # Print the ASCII art to the console
    except FileNotFoundError:
        # Removed the print statement for the error
